...
- **VS Code**がインストールされていること (他の MCP Client、Cursor、Windsurf、Kiro、CLI、Cline、 Roo、Kilo Code も可)  
  今回は Google Code Assist で試すので、VS Codeベースのエディタ推奨です。
